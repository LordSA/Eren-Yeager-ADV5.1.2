...
from plugins.Tools.help_func.last_online_hlpr import last_online
...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT,HNDLR
...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        if message.command[1] != "subscribe":
            ...
            btn.append([InlineKeyboardButton(" 🔄 𝕿𝚁𝚈 𝕬𝙶𝙰𝙸𝙽", callback_data=f"{pre}#{file_id}")])
